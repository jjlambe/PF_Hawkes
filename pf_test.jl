...
ots, ovs = PaFiHawkes.ntvppdatapreproc(obstms, obsvls) # Cleaning the data
...
param = [bg, eta, lambda]
true_loglik = PaFiHawkes.ntvxphpsmcll(ots, ovs, param, J = 100)
# print(true_loglik, "\n")
...
plot_unif = plot(1:N, [res[1][1:3:3*N-2] res[1][2:3:3*N-1] res[1][3:3:3*N]], label = ["Background" "Eta" "Lambda"])

savefig(plot_unif, raw"C:\\Users\\jlamb\\OneDrive\\PhD\\Code Projects\\PF_Hawkes\\Figures\\plot_unif.pdf")